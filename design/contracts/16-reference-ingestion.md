...
- After preactivation succeeds and the feature is active, the engine durably reserves the
  canonical `referenceStateId`, builds the canonical `ReferenceIdLedger`, assigns state-global
