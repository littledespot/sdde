...
- An `exact_copy` segment can emit such a scalar only after its token ID and citation resolve to the
...
- Exact-copy segments retain token/citation identity within the ordered business value.
