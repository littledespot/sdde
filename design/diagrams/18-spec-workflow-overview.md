...
flowchart TD
    ...
    AUTHORITY -->|Yes| GENERATE["Generate the feature brief<br/>and business specification candidates"]
    GENERATE --> REVIEW["Validate structure, citations and coverage;<br/>review semantic support"]
    ...
    CLARIFY["Create or refresh clarification forms;<br/>reuse question IDs and preserve user-closed files"]
