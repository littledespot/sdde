...
- [Spec principle review: approved design, implementation pending](#spec-principle-review--approved-design-implementation-pending)
...
The latest [R27 review](FIX_001.md#27-source-meaning-loss-and-clarification-pause-live-run-review)
...
Its [implementation work](#spec-principle-review--approved-design-implementation-pending)
is pending; the new design is not a runtime delivery.
...
#### Spec principle review — approved design, implementation pending
...
focused decision; the overall design remains Proposed. No engine implementation,
workflow resource, fixture, project principle or policy exception is changed here.
...
**Implementation sequence at shared owners:**

1. **Chunk 13 prerequisite — canonical principle inputs.** The action catalogue
   already defines capture, selection and exact cited guidance, but concrete native
   capture/selection/guidance bindings are absent today. Implement missing contracts
   once at those owners and register them through normal runner bindings. Extend
   the one configured selection table for the Spec assessment; preserve mechanical
...
**Documentation validation:** local links/anchors, Markdown fences and
`git diff --check` pass. No code, YAML, prompt/schema resource or test changed;
no runtime test, live model call or full-verification result is claimed by this amendment.
...
- [ ] Complete expanded chunk 13. **Depends on:** 00's classification decision, 04, 06.
  ...
  [ADR 0015's new scope](#spec-principle-review--approved-design-implementation-pending)
  adds canonical principle inputs and typed consistency assessment. That implementation
  is pending; the earlier mechanical diagnostic/regression delivery remains valid.
...
- [x] Complete chunk 17. **Depends on:** 10–12, 14–15.
  ...
  verification recorded in the [implementation follow-up](#spec-principle-review--approved-design-implementation-pending).
...
- [ ] Complete chunk 18. **Depends on:** 01–15, 17; 16 if it changed shared contracts.
  ...
  are now recorded. Complete readiness awaits chunk 14's shared lineage decision
  and passing complete verification. No shared request redesign is selected;
  successful configured-model behavior remains chunk 19's live evidence.
  ...
  [ADR 0015 readiness](#spec-principle-review--approved-design-implementation-pending)
