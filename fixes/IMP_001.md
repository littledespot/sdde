...
[FIX_002 §27](FIX_002.md#27-end-to-end-recovery-review--25-september-2026)
records the latest pre-generation block, the complete failure-boundary review and
the distinction between containment, scripted recovery and live quality. Its approved
bounded implementation reuses native deletion for a provably redundant misbound
projection. Full verification passed (1,223 tests), including 167 scripted workflow
scenarios and clean native packaging. Draft-first did not remove the remaining
upstream extraction/reconciliation blockers, and no successful live grade is claimed.

[FIX_002 §26](FIX_002.md#26-draft-first-specification-generation--24-september-2026)
records the user-authorized draft-first simplification: ready reference evidence
admits section generation before field review; original sources reach generation
and repair through one projection. Final review, provenance and publication gates
remain mandatory. Full offline verification passed (1,216 tests), including
native packaging. Live effectiveness is unproven.

**23 September reset:** The user requested reversing the latest stage-aware
review/D2 implementation. Its code, prompts, workflow and design amendments are
reverted; earlier work remains. [FIX_002 §16](FIX_002.md#16-small-step-reset--23-september-2026)
records the focused generation-contract regression and next experiment boundary.
The pre-rollback live failure is retained in [§15](FIX_002.md#15-approved-live-follow-up--coverage-and-diagnostic-correlation):
no publication or grade, missing token coverage and an origin-correlation error.
[FIX_002 §17](FIX_002.md#17-shared-review-instruction-experiment--23-september-2026)
records the authorized, narrowly scoped review-instruction experiment, its
mechanical regressions and baseline/revised live comparison.
[FIX_002 §19](FIX_002.md#19-approved-baselinerevised-live-comparison--23-september-2026)
records both approved runs: baseline published eight clarifications; revised
published a semantically defective completed specification, then grading rejected
three results without source evidence. Initial review improved in this pair;
candidate review still approved contradictory sections. No accepted rubric score
or end-to-end quality improvement is established. Both approvals are consumed.
[FIX_002 §20](FIX_002.md#20-candidate-role-review-and-evaluator-evidence--23-september-2026)
records the authorized follow-up: candidate-role review guidance, per-criterion
source-evidence guidance for grading, and mechanical regressions. Runtime authority
is unchanged; new live effectiveness evidence remains outstanding.
[FIX_002 §21](FIX_002.md#21-review-assignment-comparison-and-evaluator-diagnostics--23-september-2026)
records the subsequent failed grading and candidate-review false positives,
precise evaluator diagnostics, and prepared full/one-assignment comparisons using
the existing packet/replay owners. No smaller-review orchestration or additional
live execution is claimed; the comparison requires separate approval.
[FIX_002 §18](FIX_002.md#18-engine-failures-cannot-become-markdown-clarifications--23-september-2026)
records the explicit exclusion of engine errors from Markdown clarifications and
the runner-boundary regression coverage.

[FIX_002 §22](FIX_002.md#22-native-structured-output-for-grading--23-september-2026)
records the approved replacement of prompt-only Bedrock grading with native JSON
Schema through the shared encoder and capability registry. Local validation,
retry policy and accounting remain unchanged; live effectiveness is outstanding.

[FIX_002 §23](FIX_002.md#23-aggregate-diagnostic-attribution--24-september-2026)
records the shared attribution and harness-capture correction for the latest coverage
failure. It reuses existing native repair and preserves blocking outcomes when no safe
target exists; semantic quality and live grading remain separate acceptance work.

[FIX_002 §24](FIX_002.md#24-review-evidence-and-missing-finding-conformance--24-september-2026)
records the subsequent token-budget failure and shared evidence-schema/guidance
correction. Missing assessments are reported as `missing_finding`; initial and
inserted positive findings reuse the existing claim-evidence minimum. Naive
per-finding fanout is rejected by the request-cost assessment. Dynamic cardinality
binding and live semantic effectiveness remain separate decisions/evidence.

[FIX_002 §25](FIX_002.md#25-principle-citation-conformance--architecture-review)
records the first bounded implementation for the later principle-citation failure:
purpose-specific guidance through the shared review subgraph and precise registry-owned
diagnostics through repair/reporting. Full verification passed (1,723 tests), as did
native packaging; request measurements are recorded. No live improvement is claimed.
Native repeat feedback requires its focused contract decision; dynamic membership
schemas and verdict reassessment remain outside this first patch.
...
([delivery](FIX_002.md#11-approved-d1-delivery--22-september-2026)); the later D2 follow-up has been reverted at the user's request (§14). Delivery
records below do not establish live effectiveness or authorize another live run.

**Earlier retained-run review:** [FIX_002 §13](FIX_002.md#13-approved-phase-6-attempt--22-september-2026)
...
For Bedrock, enabled JSON means Structured Outputs through InvokeModel
`response_format.type: "json_schema"`, using the existing compiled-schema
