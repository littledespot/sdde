...
The latest [R29 review](FIX_001.md#31-source-identity-confusion-and-partial-recovery-live-run-review)
...
and [R29 follow-up](#r29-follow-up--source-membership-and-recovery-capacity).**
...
- [ ] Complete chunk 18. **Depends on:** 01–15, 17; 16 if it changed shared contracts.
  ...
  are implemented. Complete readiness awaits chunk 14's shared lineage decision and
  passing complete verification. The [current architecture priorities](#architecture-readiness-follow-up--shared-contracts-and-composition)
