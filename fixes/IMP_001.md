...
implemented, including independent source/policy retry composition. Remaining
proposals do not authorize other design changes or live runs. Earlier mechanical
...
- **Chunk 13 — source/principle retry identity delivered.** Source initial response
  ...
  complete validation and actual usage. The runner's invocation-lifetime counter
  scope is unchanged. Full verification remains blocked by chunk 14.
