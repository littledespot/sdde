...
The shared admission/precedence rules are documented, not implemented or verified.
D1's wire decision and optional D2 reassessment remain separate; delivery records
below do not close these requirements or authorize another live run.
