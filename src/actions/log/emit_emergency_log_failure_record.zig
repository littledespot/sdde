...
pub const Action = struct {
    ...
    pub fn execute(self: Action, shortcode: telemetry.WorkflowShortcode, code: runtime.FailureCode) void {
        var buffer: [logging.emergency_max_ascii_bytes]u8 = undefined;
...
const Capture = struct {
    bytes: [logging.emergency_max_ascii_bytes]u8 = undefined,
    length: usize = 0,
    calls: usize = 0,
