...
pub const Action = struct {
    ...
    pub fn execute(_: Action, allocator: std.mem.Allocator, source: preparation.Source, rejected: *const @import("../../domain/provider_invocation_validation.zig").CompleteCandidate, diagnostic: retry.Diagnostic, prompt: []const u8) preparation.Error!preparation.Owned {
        return retry.build(allocator, source, rejected, diagnostic, prompt);
    }
};
