...
pub const Action = struct {
    ...
    pub fn execute(_: Action, allocator: std.mem.Allocator, source: preparation.Source, original: *const @import("../../domain/llm_provider_operation.zig").IdentifiedProviderNeutralModelRequest, diagnostic: retry.Diagnostic, prompt: []const u8) preparation.Error!preparation.Owned {
        return retry.build(allocator, source, original, diagnostic, prompt);
    }
};
