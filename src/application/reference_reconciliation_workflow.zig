...
pub const progress_schema = values.schema(.reference_reconciliation_progress, owned.Value, 1, null);
pub const input_schema = values.schema(.reference_reconciliation_input, owned.Value, 1, null);
pub const raw_schema = values.schema(.raw_reference_reconciliation, owned.Value, 1, null);
pub const parsed_schema = values.schema(.parsed_reference_reconciliation, owned.Value, 1, null);
pub const summary_schema = values.schema(.validated_reference_summary, owned.Value, 1, null);
pub const summary_ids_schema = values.schema(.reference_summary_identities, owned.Value, 1, null);
