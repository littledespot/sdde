...
pub const parsed = values.schema(.parsed_specify_invocation, reference.ParsedInvocation, 1, maximum_bytes);
pub const invocation = values.schema(.specify_invocation, reference.Invocation, 1, maximum_bytes);
