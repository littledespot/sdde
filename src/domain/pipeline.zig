...
pub const DataKey = enum {
    ...
    specification_generation_session,
    raw_specification_unit,
    parsed_specification_unit,
    validated_specification_unit,
    specification_id_ledger,
    specification_coverage,
    specification_coverage_repair,
    specification_support_review,
    specification_support_repair,
    specification_omission_repair,
    source_omission_repair,
    specification_document,
    rendered_specification,
    validated_specification_rendering,
    reference_reconciliation_repair,
    reference_text_repair_authorization,
    reference_text_repair_result,
    reference_extraction_repair_authorization,
    reference_extraction_repair_result,
