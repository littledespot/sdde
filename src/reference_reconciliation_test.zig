...
test "closed reconciliation JSON rejects model identities unknown fields union variants and invented resolution" {
    ...
    for ([_][]const u8{
        ...
        "{\"global\":{\"claim_dispositions\":[],\"signals\":[],\"conflicts\":[],\"conflict_id\":1}}", "{\"global\":{\"claim_dispositions\":[],\"claim_dispositions\":[],\"signals\":[],\"conflicts\":[]}}", "{\"global\":{\"claim_dispositions\":[{\"claim_id\":{\"ordinal\":1},\"disposition\":\"resolved\",\"related_claim_ids\":[]}],\"signals\":[],\"conflicts\":[]}}", "{\"global\":{\"claim_dispositions\":[],\"signals\":[],\"conflicts\":[{\"claim_ids\":[],\"citation_ids\":[],\"kind\":\"value_mismatch\",\"summary\":{\"nodes\":[]},\"resolution\":\"source_precedence\"}]}}",
